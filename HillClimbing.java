...
public class HillClimbing {
    ...
    private static ArrayList<Object> hillClimbingToOrbitTitan(double[] currentBestVector, int currentBestCount, double[][] solarSystemInitPositions, double[][] solarSystemInitVelocities, double[] probeInitPosition, double[] probeInitVelocity, long duration) {
        ...
        int newBestCount = currentBestCount;

        while(newBestCount < duration && correction <= 1){
            ...
            ArrayList<Object> currBest = new ArrayList<Object>();
            if(count >= currentBestCount){
                ...
                correction *= 1.000001;
                currBest.add(currentBestVector);
                currBest.add(currentBestCount);
            }
            newBest = currBest;
            newBestCount = (int) currBest.get(1);
        }
        return newBest;
